...
public class DoneOrderAdapter extends RecyclerView.Adapter<DoneOrderAdapter.OrderViewHolder> {

private Context context;
private List<OrderInfo> orders;
private OnMarkAsDoneClickListener markAsDoneClickListener;

public DoneOrderAdapter(Context context, List<OrderInfo> orders, OnMarkAsDoneClickListener listener) {
...
public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View listItemView = LayoutInflater.from(context).inflate(R.layout.done_item_order, parent, false);
